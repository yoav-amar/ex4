...
namespace problem {
     ...
     */
        Problem(const std::vector<std::string>& inputFiles, const std::string& typeOfProblem);
        /**
     ...
     * @param typeOfProblem the specific problem (like add or convert) 
     */
        Matrix(const std::vector<std::string>& inputFiles, const std::string& typeOfProblem);
        /**
         * @brief solve the problem
         * 
         * @return std::string the result in a string
     ...
     * @param typeOfProblem the specific problem (like add or convert) 
     */
        Image(const std::vector<std::string>& inputFiles, const std::string& typeOfProblem);
        /**
         * @brief solve the problem
         * 
         * @return std::string the result in a string
     ...
     * @param typeOfProblem the specific problem (like add or convert) 
     */
    Hash(const std::vector<std::string>& inputFiles, const std::string& typeOfProblem);
        /**
         * @brief solve the problem
         * 
         * @return std::string the result in a string
